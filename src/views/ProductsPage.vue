<template>
            ...
            <router-link :to="`/product/${product.id}`">
              ...
              <div class="product-info">
                ...
                <div class="product-meta">
                  ...
                  <span><i class="fas fa-calendar-alt"></i> {{ formatDate(product.createdAt) }}</span>
                </div>
              </div>
            </router-link>
           <button @click.stop="addToCartWithNotification(product)" class="add-to-cart">
  ...
  orderBy     // eslint-disable-line no-unused-vars
